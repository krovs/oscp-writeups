...
We find https://www.exploit-db.com/exploits/48424 that says that there is a remote file inclusion

![](../assets/Pasted%20image%2020250318185817.png)

So we can try a php reverse shell

ABORT: **reverse shell is not connecting back, i won't lose more time on this**