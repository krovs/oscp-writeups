...
With this user `ksimpson:ksimpson` we can enumerate shares using kerberos and impacket-smbclient
...
The spn of the service is `mssql` that we can get with getuserspns
