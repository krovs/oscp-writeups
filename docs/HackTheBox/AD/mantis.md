...
- This part of the txt file is like a hash or something `NmQyNDI0NzE2YzVmNTM0MDVmNTA0MDczNzM1NzMwNzI2NDIx`
- user `admin` and database `orcharddb`

Using xxd we can convert hex to binary after b64 decode it
...
Add domain and dc to /etc/hosts and using impacket-goldenPac we can enter as administrator.
