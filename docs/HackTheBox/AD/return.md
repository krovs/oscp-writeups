...
We have a web config portal in port 80
...
We can use service operators group and manipulate a service, use services command to list them and try one, then, put the binpath to change administrator password
