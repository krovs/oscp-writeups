...
Enumerating the filesystem I found a PS history in 
`C:\PSTranscripts\20191203\PowerShell_transcript.RESOLUTE.OJuoBGhU.20191203063201.txt`

Make it visible before downloading it or evil-winrm fails
...
We can see that this user belongs in DnsAdmins group, this group can execute and manage DNS in the DC.
https://lolbas-project.github.io/lolbas/Binaries/Dnscmd/
So we can search for the program in system32 called dnscmd.exe.

Also, there is a note in his desktop:
...
Start a smb share and start a listener.

```bash
$ impacket-smbserver s .
```

Now execute the setting of the dll and stop and start de service for the program to load it.
