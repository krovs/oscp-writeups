...
Enumerating shares with empty session we find a file in Shares/Dev
...
We have a password, and inside, a .pfx cert but has a password too. Wd can use https://github.com/crackpkcs12/crackpkcs12 (p12tool doesn't work)
...
We are in LAPS_Readers group so we can try to read passwords, trying with crackmapexec --laps doesn't work so i'll try https://www.thehacker.recipes/ad/movement/dacl/readlapspassword
...
And we have `m{292kr#Es(3K8R7u86t(l$J` lets try evil-winrm again.
